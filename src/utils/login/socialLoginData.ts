...
const KAKAO_REDIRECT_URI =
  'https://front-end-farmer-shop.vercel.app/login/kakao'; // 추후 배포 주소로 변경 예정
...
const NAVER_REDIRECT_URI =
  'https://front-end-farmer-shop.vercel.app/login/naver';
// const STATE = 'Farmer';
...
const GOOGLE_REDIRECT_URI =
  'https://front-end-farmer-shop.vercel.app/login/google';
