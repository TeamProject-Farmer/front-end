    ...
    <Styled.Wrapper>
      ...
      <Styled.InfoBox>
        <Styled.Info>
          ...
          <Styled.Content>owner. 파머 프로젝트 팀 tel. 031-000-0000</Styled.Content>
          <Styled.Content>주소 : 서울시 영등포구 은평로 123 파머하이테크시티 3층 203호 </Styled.Content>
          <Styled.AccountBox>
        ...
        <Styled.Info>
          ...
          <Styled.Content>평일 AM 09:00 ~ PM 05:30 / 주말, 공휴일 휴무</Styled.Content>
